# Django-Todo
 ...
 The CI/CD automation will create a docker image and push to farhan1471/todo_app repository on docker hub. From there gitlab runner
 would pull the image and run in a docker container for testing purposes.
 <br></br>
 <ul>
